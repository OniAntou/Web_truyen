import {  Comic, Genre  } from "../Database/database";
import {  getChapterCounts, processGenres  } from "../utils/helpers";
import {  User, ChapterUnlock  } from "../Database/database";
import {  resolveR2Url, resolveR2Urls, deleteFromR2  } from "../config/r2";
import {  Chapter, Pages, Upload, Rating, ComicView, Comment, Favorite  } from "../Database/database";
