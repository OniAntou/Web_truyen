    ...
    useEffect(() => {
        const fetchHistory = async () => {
            ...
            try {
                ...
                const mappedHistory: HistoryItem[] = (data || []).map((item: Record<string, unknown> & { comic_id: string; comic_title: string; comic_cover: string; chapter_id: string; chapter_title: string; chapter_number: number | string; updated_at: string; }) => ({
