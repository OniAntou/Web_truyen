                                    ...
                                    <div className="max-h-60 overflow-y-auto custom-scrollbar p-2 outline-none">
                                        ...
                                        {genres.map((g) => {
                                            ...
                                            return (
                                                <button
                                                    key={gKey}
                                                    className={`w-full text-left px-4 py-2.5 rounded-xl text-sm font-semibold mb-1 transition-colors ${selectedGenre === gName ? 'opacity-100' : 'opacity-60 hover:opacity-100'}`}
                                                    style={{ background: selectedGenre === gName ? 'var(--accent)' : 'transparent', color: selectedGenre === gName ? 'white' : 'var(--text-primary)' }}
