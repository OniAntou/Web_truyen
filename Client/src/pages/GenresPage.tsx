...
const GenresPage: React.FC = () => {
    ...
    const [selectedGenre, setSelectedGenre] = useState<string | null>(searchParams.get('type'));
                    ...
                    <div className="w-full lg:w-1/3 xl:w-[380px] shrink-0 sticky top-24">
                        ...
                        <div className="relative flex items-center w-full mb-6">
                            ...
                            <input
                                ...
                                style={{ background: 'var(--bg-secondary)', color: 'var(--text-primary)', borderColor: 'var(--border)', '--tw-ring-color': 'var(--accent)' } as any}
                            />
                            {searchQuery && (
                                <button 
                    ...
                    <div className="flex-1 min-w-0 w-full">
                        {selectedGenre ? (
                            <div className="animate-fade-in w-full">
                                ...
                                {comicsLoading ? (
                                    <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-3 md:gap-x-6 md:gap-y-10">
                                        {Array.from({ length: 8 }).map((_, i) => (
                                            <SkeletonCard key={i} />
                                        ))}
                                    </div>
