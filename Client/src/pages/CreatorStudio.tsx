...
const CreatorStudio: React.FC = () => {
    const [comics, setComics] = useState<StudioComic[]>([]);
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                        {comics.map(comic => (
                            <div key={comic._id || comic.id} className="group relative flex flex-col gap-4">
                                ...
                                <button 
                                    onClick={(e) => { e.preventDefault(); handleDeleteComic((comic._id || comic.id) as string); }}
                                ...
                                <div className="space-y-3">
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                        {comic.genres?.slice(0, 2).map((g: { name: string }, i: number) => (
